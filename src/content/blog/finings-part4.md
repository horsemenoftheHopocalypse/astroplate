---
title: "Beer Clarity and Finings, Part 4"
meta_title: ""
description: "Beer Clarity and Finings, part four"
...
In the previous sections we discussed how to measure clarity, causes of poor clarity, proteins and tannins and how to control and improve beer clarity in the mash and the boil. Today we’re going to discuss fermentation finings and filtering your beer to improve clarity and reduce beer haze.
...
Note that cold crashing (rapidly chilling the beer to near freezing) will kill off any remaining yeast, so you should not use this technique when bottling unless you are planning to pitch additional yeast when bottling. If you cold crash a beer you are bottling, and don't add additional yeast to aid in carbonation you will get flat beer.
...
- **Gelatin —** Available in the Jell-O section of the grocery store - in 'unflavored' packets. Prepare a packet in a pint of hot water, and then add it to your 5 gal (19 liter) batch a few days before bottling. Works on both proteins and tannins.
...
If you do all of these things you should get clean clear beer every time!
