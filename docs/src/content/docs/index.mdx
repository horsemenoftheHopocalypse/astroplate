---
title: Welcome Horsemen of the Hopocalypse
description: Everything you need to know to get content published
#template: splash # Remove or comment out this line to display the site sidebar on this page.
hero:
  tagline: Let's get some fresh content brewing
  image:
    file: ../../assets/houston.webp
  actions:
    - text: Example Guide
      link: /astroplate/guides/announcement/
      icon: right-arrow
