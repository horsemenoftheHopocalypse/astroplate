...
import completedEvent from '../../../assets/completed-event.jpg';
...
<img src={eventCard.src} title="Event Card" alt="Event Card" height="250" width="400" />
</Card>
<Card title="Completed Event">
<img src={completedEvent.src} title="Completed Event Card" alt="Completed Event Card" height="250" width="400" />
</Card>
</CardGrid>
